  ...
  return (
    <div className="wood-frame animate-pop flex w-full flex-col overflow-hidden rounded-xl">
      <button
        ...
        aria-controls="vote-summary-body"
      ...
      >
        <div className="flex items-center gap-2">
          ...
          {allAgree && (
            <span className="rounded-full border border-gold/60 bg-gold/15 px-1.5 py-0.5 font-serif text-[9px] font-bold uppercase tracking-wider text-gold-soft">
              Agreement
            </span>
          )}
        </div>
      ...
      {!collapsed && (
        <div
          id="vote-summary-body"
          className="flex flex-col gap-2 overflow-hidden px-2.5 pb-2.5"
        >
